/*
	Starry - Draw randomly blinking squares in a texture.
...
namespace TabletVR {
	public class Starry : MonoBehaviour {
		// These fields made public so they are serialized by Unity IDE
		// and made accessible to the user when designing the scene.
